...
<div class="input-group">
<div class="input-group-addon">$</div>
<input type="text" value="0" class="form-control" name="amount_paid" id="amount_paid" placeholder="Amount Paid" ondrop="return false;" onpaste="return false;" onkeydown="if (event.keyCode == 13) return false;">
</div>
</div>
<div class="form-group">
...
<button data-loading-text="Saving sale ..." type="submit" name="invoice_btn" class="btn btn-success submit_btn form-control"> <i class="fa fa-floppy-o"></i> Save sale & Print</button>
