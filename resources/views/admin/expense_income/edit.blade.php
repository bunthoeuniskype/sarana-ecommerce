...
<div class="col-xs-6 col-xs-offset-3">
 <div class="panel panel-defualt">
                        ...
                        <h3 style="margin-top: 5px;"> {{ trans('common.edit') }} {{ trans('common.expense_income') }} </h3>
                         </div>
...
@include('errors/errors')
 ...
 {!! Form::model($exp_inc, array('route' => array('expense_income.update', $exp_inc->id),'method'=>'PUT','files'=>true)) !!}
