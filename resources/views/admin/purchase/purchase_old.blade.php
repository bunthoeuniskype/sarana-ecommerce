...
<div class="panel panel-defualt" style="margin-top:-20px; padding: 0px;">
           <div class="panel panel-heading clearfix" style="padding-top: 5px;">
                        <h3 style="margin-top: 5px;"><i class="fa fa-database"></i> {{ trans('common.purchase') }} </h3>
                         </div>
       <div class="panel panel-body" style="padding: 0px;">                    
 
             @if(Session::has('save'))
                        <div class="alert alert-success">
                        <em>{!! Session('purchase_create') !!}</em>
...
@else
<tr>
<td colspan="9" align="center" style="font-size:18px">​ No Item in Cart </td>
</tr>
@endif 
...
<div class="input-group">
<div class="input-group-addon">$</div>
<input type="text" pattern="[0-9.]*" value="0" class="form-control" name="discount_amount" id="DiscountAmount" placeholder="Discount Amount"  ondrop="return false;" onpaste="return false;" onkeydown="if (event.keyCode == 13) return false;">
</div>
</div>
...
<div class="input-group">
<div class="input-group-addon">$</div>
<input type="number" class="form-control" readonly="true" name="amount_due" value="{{$data['totalCost']}}" id="amount_due" placeholder="Amount Due" value="0">
</div>
</div>

<button data-loading-text="Saving Purchase ..." type="submit" name="invoice_btn" class="btn btn-success submit_btn form-control"> <i class="fa fa-floppy-o"></i> Save Purchase & Print</button>
