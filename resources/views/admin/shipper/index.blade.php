...
<div class="row">
  <div class="col-xs-12" style="padding-left: 15px; padding-right:15px;"> 
   ...
   <div id="panel panel-default" style="margin-top: -20px;">
                  ...
                  <div class="panel panel-heading clearfix" style="margin-bottom: -15px;">
                         <a href="{{ url('admin/shipper/create') }}"><button class="btn btn-primary pull-right"><i class="fa fa-plus" aria-hidden="true"></i>  {{ trans('common.add') }} {{ trans('common.new') }}</button></a>
                        <h3 style="margin-top: 5px;">{{ trans('common.list') }} {{ trans('common.shipper') }} </h3>
                         </div>
 ...
 @if(Session::has('save'))
  ...
  @endif
    ...
    <table class="table table-striped table-bordered nowrap table-over" id="shipper-table">      
        ...
        @foreach($shipper as $value)
          <tr>
            ...
            <td>@if($value->image == '')
             ...
             <td>{{ $value->address }}</td>
            <td>
            <a href="{{ url('admin/shipper/'.$value->id.'/delete') }}" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-trash-o"></i> {{ trans('common.delete') }}</a>
            <a href="{{ url('admin/shipper/'.$value->id.'/edit') }}" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i> {{ trans('common.edit') }}</a>
            </td>
